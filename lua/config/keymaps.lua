...
map("n", "<leader>s<space>", "<cmd>Telescope find_files cwd=..<cr>", { desc = "Fzf in parent dir" })
...
map("n", "<leader>ud", function() Util.toggle.option() end, { desc = "Toggle Diagnostics" })
...
map("n", "<leader>rc", "<Cmd>lua require'rust-tools'.open_cargo_toml.open_cargo_toml()<CR>", { desc = "Open Config.toml" })
--map("n", "<leader>rr", "<Cmd>RustRunnables<CR>", { desc = "Rust Runnables" })
